...
public class LoginController {
    ...
    private void goToRegistration(ActionEvent event) throws IOException {
        model.openCloseFXML("/com/example/elaborato_ing/viewUtente/Registration.fxml", event);
    }

    @FXML
    private void goToLogin(ActionEvent event) throws IOException {
        model.openCloseFXML("/com/example/elaborato_ing/viewUtente/Login.fxml", event);
    }
    ...
    private void accedi(ActionEvent event) throws IOException {
        ...
        if (model.autenticato(username, password) == 2) {
            ...
            model.openCloseFXML("/com/example/elaborato_ing/viewSegreteria/Segreteria.fxml", event);
