...
public class SegreteriaController {
    ...
    public void initialize() {
        ...
        model.onCloseFXML("/com/example/elaborato_ing/viewUtente/Configuratore.fxml", marca);
    ...
    public void modificaAuto(ActionEvent event) throws IOException {
        model.openCloseFXML("/com/example/elaborato_ing/viewSegreteria/ModificaAuto.fxml", event);
    }

    public void eliminaAuto(ActionEvent event) throws IOException {
        model.openCloseFXML("/com/example/elaborato_ing/viewSegreteria/EliminaAuto.fxml", event);
    }
}